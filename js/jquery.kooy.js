(function ($) {
	...
	kooy.prototype = {
		...
		// May want to add call back funtion from option
			this.widget.on( 'keypress.kooy', $.proxy( this.keyPress, this ) );
			this.widget.on( 'keydown.kooy', $.proxy( this.keyDown, this ) );	
			this.widget.on( 'destroy.kooy', $.proxy( this.destroy, this ) );
			this.widget.on( 'enable.kooy', $.proxy( this.enable, this ) );
			this.widget.on( 'disable.kooy', $.proxy( this.disable, this ) );
		},
		keyDown: function(event){

			//TODO toggle short key
		...
		transliterate: function(event){
			...
			if(malChr){
				if(isExplorer()){
					...
					stepback = range - this.patternStart;
					...
					element.selectionStart = curLoc + malChr.length - stepback;
					element.selectionEnd = curLoc + malChr.length - stepback;
